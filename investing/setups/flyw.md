...
entry_trigger: "enter near $18.13 ahead of the 2026-08-04 print"
entry_price: 18.13
stop_price: 16.73
stop_logic: "chandelier trail: HH22 $18.98 - 3x ATR $0.75 = $16.73 — exit when decline exceeds ~3 average daily ranges"
target_price: 20.23
target_logic: "T1 $20.23 = entry $18.13 + 1.5x R (R=$1.40); T2 $22.33 = entry + 3x R; structure ceiling = 52w high $18.98"
holding_window_days: 21
catalyst: "2026-08-04 earnings"
earnings_plan: exit_before   # machine default — change to hold_through_sized_down ONLY deliberately; sizing then uses the 25% gap assumption
liquidity_check: "avg $vol $43.1M; pass"
